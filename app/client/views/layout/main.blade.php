            ...
            <div class="container"><a class="navbar-brand" href="index.html"><img
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
                        <li class="nav-item px-2"><a class="nav-link active" aria-current="page" href="index.html">Trang
                                chủ</a></li>
                        <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="pricing.html">Giá</a>
                        </li>
                        <li class="nav-item px-2"><a class="nav-link" aria-current="page"
                                href="web-development.html">Phát triển website</a></li>
                        <li class="nav-item px-2"><a class="nav-link" aria-current="page"
                                href="user-research.html">Nghiên cứu</a></li>
                                ...
                                <div class="card-body">
                                    <div class="row flex-center gx-0">
                                        ...
                                        <div class="col-lg-8 col-xl-9">
                                            <h5 class="font-sans-serif fw-bold">Full Stack Web Development with Node.js
                                                and MongoDB</h5>
                                            <p class="text-muted fs--1">Khóa học này tập trung vào việc phát triển các
