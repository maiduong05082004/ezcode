...
<link rel="icon" type="image/png" sizes="16x16" href="{{ route('public/assets/img/favicons/favicon-16x16.png')}}">
<link rel="shortcut icon" type="image/x-icon" href="{{ route('public/assets/img/favicons/favicon.ico')}}">
<link rel="manifest" href="{{ route('public/assets/img/favicons/manifest.json')}}">
